    ...
    <html lang="en">
      ...
      >
        <div className="relative">
          {children}
          <div className="absolute hidden w-full h-full backdrop-blur-sm p-6 bg-black/30 top-0 left-0">
          <div className=" p-4 rounded-2xl bg-black/50  w-full md:w-3/4  h-fit mt-20 md:mt-40 m-auto text-center">
